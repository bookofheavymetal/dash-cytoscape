            ...
            dcc.Tab(label='Actions', children=[
                dbc.Col(
                    children=[
                        dbc.Row(
                            children=[
                                dbc.Col(html.Button('Remove Selected Nodes', id='remove-nodes-button')),
                                dbc.Col(html.Button('Rename Selected Node', id='rename-node-button'))
                            ]
                        ),
                        dbc.Row(
                            children=[
                                dbc.Col(html.Button('Remove Selected Edges', id='remove-edges-button')),
                                dbc.Col(html.Button('Add New Edge', id='add-new-edge-button'))
                            ]
                        )
                    ],
                ),
